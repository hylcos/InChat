/*
 * Read one message from Tibco queue 
 * 
 */

/*
 * Usage:  ReadMessage [options]
 *
 *    where options are:
 *
 *      -server     Server URL.
 ...
 *      -topic      Topic name. Default is "sample"
 *      -queue      Queue name. No default
 *      -messages   Number of messages to read (default is 1)
...
void usage() 
{
    ...
    printf(" -messages (number>     - Number of messages to read, default is 1\n");
...
int main(int argc, char** argv)
{
    ...
    printf(" Number of messages to read... %u\n",counter); 
    printf("------------------------------------------------------------------------\n\n");
